...
import org.smartsoft.movil.buzzme.gui.R;
...
public class VerticalProgressBar extends View {
    ...
    public VerticalProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(attrs, org.smartsoft.movil.buzzme.gui.R.styleable.ProgressBar, defStyle, 0);

        mNoInvalidate = true;

        Drawable drawable = a.getDrawable(org.smartsoft.movil.buzzme.gui.R.styleable.ProgressBar_android_progressDrawable);
        if (drawable != null) {
